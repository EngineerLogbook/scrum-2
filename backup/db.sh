...
docker exec -i log_application python manage.py dumpdata --indent 4 --natural-foreign > /django_management.dbdump.sql
rclone copy /postgres.dbdump.sql logdrive:Backups/database >> /var/log/cron.log 2>&1
rclone copy /django_management.dbdump.sql logdrive:Backups/database >> /var/log/cron.log 2>&1
